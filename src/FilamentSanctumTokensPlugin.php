...
use Aybarsm\Filament\SanctumTokens\Concerns\HasFilamentPluginMethods;
...
final class FilamentSanctumTokensPlugin implements PluginContract
{
    use HasFilamentPluginMethods;
    ...
    public function getDiscoveredModels(): array
    {
        ...
        if (!array_key_exists('discovered', $cache)) {
            $cache['discovered'] = $this->buildModelDiscovery();
        }
